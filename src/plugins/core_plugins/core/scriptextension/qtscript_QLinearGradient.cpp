...
static const int qtscript_QLinearGradient_function_lengths[] = {
    4
    // static
    // prototype
    , 0
...
QScriptValue qtscript_create_QLinearGradient_class(QScriptEngine *engine)
{
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QLinearGradient_static_call, proto, qtscript_QLinearGradient_function_lengths[0]);
