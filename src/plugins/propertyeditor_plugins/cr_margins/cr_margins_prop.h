...
#ifndef PROPERTYEDITOR_CRMARGINS_H
#define PROPERTYEDITOR_CRMARGINS_H
...
class CR_MarginsProp : public PropertyInterface
{
	Q_OBJECT
...
public:
    CR_MarginsProp(QObject* parent = 0, QObject* object = 0, int property = -1, const PropertyModel * propertyModel = 0);
