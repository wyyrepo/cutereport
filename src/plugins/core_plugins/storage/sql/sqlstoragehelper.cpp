...
SqlStorageHelper::SqlStorageHelper(StorageSql * storage, CuteDesigner::Core * designer, VisibleOptions visibleOptions) :
    CuteReport::StorageHelperInterface(storage, designer, visibleOptions),
