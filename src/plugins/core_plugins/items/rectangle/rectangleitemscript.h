...
{
    QScriptValue clazz = engine->globalObject().property(QString::fromLatin1("Rectangle"));
...
static const char * const qtscript_RectangleItem_function_names[] = {
    "Rectangle"
    , "toString"
};


static QScriptValue qtscript_RectangleItem_static_call(QScriptContext *context, QScriptEngine *)
{
    ...
    switch (_id) {
        case 0:
            return context->throwError(QScriptContext::TypeError,
                                       QString::fromLatin1("RectangleItem cannot be constructed"));
            break;

        default:
            Q_ASSERT(false);
    }
    return qtscript_Qt_throw_ambiguity_error_helper(context,  qtscript_RectangleItem_function_names[_id],  "" /*qtscript_Qt_function_signatures[_id]*/);
}


QScriptValue qtscript_create_RectangleItem_class(QScriptEngine *engine)
{
    QScriptValue proto = QScriptValue();
    QScriptValue ctor = engine->newFunction(qtscript_RectangleItem_static_call, proto, 0);
...
void registerRectangleItemScriptClass(QScriptEngine *engine)
{
    QScriptValue extensionObject = engine->globalObject();
    extensionObject.setProperty("Rectangle", qtscript_create_RectangleItem_class(engine), QScriptValue::SkipInEnumeration);
}
