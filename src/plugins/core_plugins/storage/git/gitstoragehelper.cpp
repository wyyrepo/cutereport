...
GitStorageHelper::GitStorageHelper(StorageGit *storage, CuteDesigner::Core *designer, VisibleOptions visibleOptions) :
    ...
    m_storage(storage)
{
    ...
    connect(storage, SIGNAL(syncMessage(QString)), this, SLOT(showSyncMessage(QString)));
