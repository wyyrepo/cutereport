...
class LineItem : public CuteReport::ItemInterface
{
    ...
    Q_PROPERTY(LineStyle lineStyle READ lineStyle WRITE setLineStyle NOTIFY lineStyleChanged DESIGNABLE false)
...
public:
    ...
    virtual CuteReport::BaseItemHelperInterface * createHelper();
...
public:
    ...
    {
        Q_UNUSED(widget)
        LineItem::paint(painter, option, ptr(), rect(), CuteReport::RenderingTemplate);
    }
};
...
public:
    ...
    {
        Q_UNUSED(widget)
        LineItem::paint(painter, option, d_ptr, rect(), CuteReport::RenderingReport);
    }
