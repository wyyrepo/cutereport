...
//    Q_PROPERTY(qreal bandsIndention READ bandsIndention WRITE setBandsIndention NOTIFY bandsIndentionsChanged)
    ...
    Q_PROPERTY(bool resetPageNumber READ getResetPageNumber WRITE setResetPageNumber NOTIFY resetPageNumberChanged)

    // override not used properties
    Q_PROPERTY(bool printOnPreviousPage READ printOnPreviousPage WRITE setPrintOnPreviousPage DESIGNABLE false)
    Q_PROPERTY(bool allowMirrorMargins READ allowMirrorMargins WRITE setAllowMirrorMargins DESIGNABLE false)
    Q_PROPERTY(bool endlessWidth READ endlessWidth WRITE setEndlessWidth DESIGNABLE false)
    Q_PROPERTY(bool endlessHeight READ endlessHeight WRITE setEndlessHeight DESIGNABLE false)
...
public:
    ...
    virtual CuteReport::PageHelperInterface * createHelper(CuteReport::DesignerItemInterface * designer);
    ...
    virtual int pageFlags() const;
    virtual void setPageFlags(int flags, bool value = true);
    virtual bool isPageFlagSet(int flag);
    ...
    bool getResetPageNumber() const;
    void setResetPageNumber(bool value);
...
signals:
    ...
    void resetPageNumberChanged(bool);
