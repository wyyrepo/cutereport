...
//    ui->cbDatasets->clear();
    ...
    ui->tabs->setPalette(this->palette());
    ui->tabs->hide();
}
...
//    m_core->setSettingValue("CuteReport_DatasetEditor/splitter2State", ui->splitterTestPage->saveState());
    m_reportEditor->core()->setSettingValue("CuteReport_ReportEditor/tabMode", ui->tabs->mode());
...
//    ui->tabs->SetCurrentIndex(0);
    ...
    ui->tabs->SetMode(FancyTabWidget::Mode(m_reportEditor->core()->getSettingValue("CuteReport_ReportEditor/tabMode", default_mode).toInt()));
...
void ReportContainer::saveEnabled(bool b)
{
    ui->saveReport->setEnabled(b);
}


void ReportContainer::deleteEnabled(bool b)
{
    ui->closeReport->setEnabled(b);
}
