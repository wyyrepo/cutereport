...
public:
    ...
    CuteReport::RenderedItemInterface * renderView(quint32 id);
    ...
    virtual void setTemplateDetailLevel(const CuteReport::TemplateItemDetailLevel &value);
...
signals:
    ...
    void lineSpacingChanged(qreal);
    void textIndentChanged(qreal);
