...
private slots:
    void slotItemHelperRequest(CuteReport::BaseItemInterface * item);
    void slotPageHelperRequest();
    ...
    void slotObjectsLoad();
    void slotObjectsSave();

    void slotObjectInspectorDeletePressed();
...
private:
    ...
    QAction * m_objectsLoadAction;
    QAction * m_objectsSaveAction;
