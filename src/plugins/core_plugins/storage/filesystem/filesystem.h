...
class StorageFileSystem : public CuteReport::StorageInterface
{
    ...
    Q_PROPERTY(bool rootRelative READ rootRelative WRITE setRootRelative NOTIFY rootRelativeChanged)
...
public:
    ...
    virtual QString normalizedURL(const QString & url);
    ...
    virtual QString objectNameHint() const {return QString("file");}
    ...
    //* defines if relative pathes relative to rootPath or to current path
    bool rootRelative();
    void setRootRelative(bool b);
