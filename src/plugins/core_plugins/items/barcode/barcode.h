...
public:
    ...
    static void paint(QPainter * painter, const QStyleOptionGraphicsItem *option, BaseItemInterfacePrivate *data, const QRectF &boundingRect, RenderingType type = RenderingTemplate);
...
public:
    ...
    {
        Q_UNUSED(widget)
        BarcodeItem::paint(painter, option, ptr(), rect(), RenderingTemplate);
    }
};
...
public:
    ...
    {
        Q_UNUSED(widget)
        BarcodeItem::paint(painter, option, d_ptr, rect(), RenderingReport);
    }
