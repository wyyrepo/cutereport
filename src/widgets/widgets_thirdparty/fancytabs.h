...
class WIDGET_THIRDPARTY_EXPORTS FancyTabProxyStyle : public QProxyStyle {
    Q_OBJECT
...
class WIDGET_THIRDPARTY_EXPORTS TabBar : public QTabBar
{
   Q_OBJECT
public:
...
class WIDGET_THIRDPARTY_EXPORTS FancyTab : public QWidget{
    Q_OBJECT
...
class WIDGET_THIRDPARTY_EXPORTS FancyTabBar : public QWidget
{
    Q_OBJECT
...
class WIDGET_THIRDPARTY_EXPORTS FancyTabWidget : public QWidget {
    Q_OBJECT
...
class WIDGET_THIRDPARTY_EXPORTS FancyTabContainer : public QWidget
{
    Q_OBJECT
