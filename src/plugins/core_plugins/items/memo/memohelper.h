...
public:
    ...
    MemoHelper(MemoItem *item, CuteReport::DesignerItemInterface *designer);
    MemoHelper(RenderedMemoItem * renderedMemo);
    ~MemoHelper();
