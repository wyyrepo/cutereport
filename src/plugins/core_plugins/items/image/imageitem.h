...
//    virtual void update_gui();
    ...
    static void paint(QPainter * painter, const QStyleOptionGraphicsItem *option, CuteReport::BaseItemInterfacePrivate *data, const QRectF &boundingRect = QRectF(), CuteReport::RenderingType type = CuteReport::RenderingTemplate);
...
public:
    ...
    {
        Q_UNUSED(widget)
        ImageItem::paint(painter, option, ptr(), rect(), CuteReport::RenderingTemplate);
    }
};
