...
QString Script::moduleShortName() const
{
    return "Script";
}
...
void Script::initialize(const QString &key, QScriptEngine *engine)
{
...
CuteReport::ScriptExtensionInterface *Script::createInstance(QObject *parent) const
{
