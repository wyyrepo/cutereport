...
class  ChartRenderedItem : public CuteReport::RenderedItemInterface
{
public:
    explicit ChartRenderedItem(CuteReport::BaseItemInterface * item, CuteReport::BaseItemInterfacePrivate *itemPrivateData)
