...
QGradient Brush::gradient()
{
    const QGradient * currentGradient = value().value<QBrush>().gradient();
    if (!currentGradient) {
        return QGradient();
    }
...
void Brush::setGradient(const QGradient &gradient)
{
//    switch (gradient.type) {
//        case QGradient::LinearGradient: {
//            QLinearGradient g(0,0,0,1);
//            g.setCoordinateMode(QGradient::ObjectBoundingMode);
//            g.setStops(gradient.stops.toVector());
//            QBrush b = QBrush(g);
//            setValue(b);
//            }
//            break;
